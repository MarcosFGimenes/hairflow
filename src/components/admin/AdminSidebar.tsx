...
import { LayoutDashboard, CalendarDays, Clock, Users, Settings, LogOut, Bell, LayoutGrid } from 'lucide-react'; // NEW: Added LayoutGrid icon
...
const navItems = [
  ...
  { href: '/admin/agendamentos', label: 'Agendamentos', icon: CalendarDays }, // Changed to agendamentos as per your file structure
  { href: '/admin/slots', label: 'Gerenciar Horários', icon: Clock },
  { href: '/admin/professionals', label: 'Profissionais', icon: Users },
  { href: '/admin/services', label: 'Serviços', icon: LayoutGrid }, // NEW: Added Services link
  { href: '/admin/settings', label: 'Configurações do Salão', icon: Settings },
];
